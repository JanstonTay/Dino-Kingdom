document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderDinos(dinos) {
        ...
        dinos.forEach(dino => {
            ...
            card.innerHTML = `
                <div style="height: 200px; display: flex; justify-content: center; align-items: center; margin-bottom: 1rem; overflow: hidden; border-radius: 8px; background: rgba(0,0,0,0.2);">
                    <img src="${imgPath}" alt="${dino.name}" style="max-height: 100%; max-width: 100%; object-fit: contain;" onerror="this.style.display='none'; this.parentElement.innerHTML='<span style=\\'font-size:4rem;\\'>🦕</span>';">
                </div>
